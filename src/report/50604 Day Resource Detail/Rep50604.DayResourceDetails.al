report 50604 "Day Resource Details"
{
    ...
    dataset
    {
        ...
        {
            dataitemtableview = sorting("Plan Date", "Assigned Resource No.") where("plan status" = const("In Progress"),
                "assigned Resource No." = filter(<> ''));
            RequestFilterFields = "Plan Date";
            ...
            begin
                ...
                resource.setrange("date filter", DayPlanning."Plan Date");
        ...
        DataItem(TempRes; Integer)
        {
            ...
            column(TaskDate2; DayPlanning."Plan Date") { }
            ...
            begin
                if tempres.Number = 1 then
                    ...
                    TEMPresource.Next();
                TEMPresource.setrange("date filter", DayPlanning."Plan Date");
