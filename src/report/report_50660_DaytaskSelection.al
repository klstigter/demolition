report 50660 "DayPlanning Selection"
{
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Work Date", "Job No.", "Job Task No.", "Assigned Resource No.";
            ...
            begin
                ...
                if DayPlanningJnlLine.Get(TemplateName, BatchName, DayPlanning."Work Date", DayPlanning."Day Line No.") then
                    CurrReport.Skip();

                DayPlanningJnlLine.Init();
                DayPlanningJnlLine."Template Name" := TemplateName;
                DayPlanningJnlLine."Batch Name" := BatchName;
                DayPlanningJnlLine."DayPlanning Date" := DayPlanning."Work Date";
                DayPlanningJnlLine."DayPlanning Line No." := DayPlanning."Day Line No.";
                DayPlanningJnlLine."Document No." := GetDocumentNo(DayPlanning."Work Date");
