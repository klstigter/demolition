report 50602 DayPlanning
{
    ...
    dataset
    {
        ...
        {
            dataitemtableview = sorting("Job No.", "Job Task No.", "Plan Date") where("plan status" = const("In Progress"));
            ...
            column(TaskDate; DayPlanning."Plan Date")
            {
                Caption = 'Task Date';
            }
            dataitem(Integer; "Integer")
            {
...

                {
                    ...
                    column(AssignedHours; DayPlanning2."Assigned Hours")
                    {
                    ...
                    begin
                        ...
                        if resource.Get(DayPlanning2."Assigned Resource No.") then begin
                            if not TEMPresource.Get(DayPlanning2."Assigned Resource No.") then begin
                                TEMPresource.Init();
                                TEMPresource."No." := DayPlanning2."Assigned Resource No.";
            ...
            begin
                ...
                dateFilter := DayPlanning.GetFilter("Plan Date");
                DayPlanning.SetRange("Plan Date", DayPlanning."Plan Date");
    ...
    rendering
    {
        ...
        // {
        //     Type = Excel;
        //     LayoutFile = 'src/report/50602 DayPlannings/mySpreadsheet.xlsx';
        // }
        layout(DayPlanningReport)
        {
            Type = Rdlc;
            LayoutFile = 'src/report/50602 DayPlannings/DayPlanningReport.rdlc';
        }
    }
        ...
        if tempresource.FindSet() then
            repeat
                if not TEMPresourcePool.get(tempresource."pool Resource no.") then begin
                    ...
                    TEMPresourcePool."Direct Unit Cost" := DayPlanning2."Assigned Hours";
    ...
    begin
        if ValidateYrWkFilterFormat(WeekFilter) then begin
            ...
            DayPlanning.SetRange("Plan Date", FirstDateOfWeek, LastDateOfWeek);
        end;
    end;
