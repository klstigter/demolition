page 50630 "Day Plannings"
{
    ...
    layout
    {
            ...
            repeater(Lines)
            {
                ...
                field("Total Assigned Hours"; TotAssignedHours)
                {
                    ...
                    begin
                        ...
                        DayPlanningRec.SetRange("Plan Date", Rec."Plan Date");
        ...
        area(FactBoxes)
        {
            ...
            {
                ApplicationArea = All;
                SubPageLink = "Plan Date" = field("Plan Date"),
    ...
    trigger OnOpenPage()
    begin
        Rec.SetCurrentKey("Job No.", "Job Task No.", "Plan Date", "Day Line No.");
        Rec.Ascending(true);
    end;
    ...
    begin
        rec."Day Line No." := rec.GetNextDayLineNo(rec."Plan Date", rec."Job No.", rec."Job Task No.");
    ...
    begin
        PrevRec.SetCurrentKey("Job No.", "Job Task No.", "Plan Date", "Day Line No.");
        PrevRec.CopyFilters(Rec);
        PrevRec."Job No." := Rec."Job No.";
        PrevRec."Job Task No." := Rec."Job Task No.";
        PrevRec."Plan Date" := Rec."Plan Date";
