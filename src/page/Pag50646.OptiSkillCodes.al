page 50646 "Opti Skill Codes"
{
    ...
    procedure SetTempSkill(var TempSkill: Record "Skill Code" temporary)
    begin
        IF TempSkill.FindSet() THEN
            repeat
                Rec.Copy(TempSkill, true);
            UNTIL TempSkill.Next() = 0;
    end;
