page 50679 "Opti Day Pattern Lines"
{
    PageType = ListPart;
    ...
    var
        ...
        TimeSlotInput: Page "Opti Time Slot Dialog";
    ...
    begin
        ...
        DayPatternLine.Init();
        DayPatternLine."Day Pattern ID" := DayPatternID;
        DayPatternLine."Line No." :=
            GetNextLineNo(DayPatternID);
    ...
    begin
        ...
        if Rec.GetFilter("Day Pattern ID") = '' then begin
            Rec.FilterGroup(CurrentFilterGroup);
            Error(DayPatternNotSelectedErr);
        end;

        DayPatternID := Rec.GetRangeMin("Day Pattern ID");
    ...
    local procedure GetNextLineNo(DayPatternID: Integer): Integer
    var
        DayPatternLine: Record "Opti Day Pattern Line";
    begin
