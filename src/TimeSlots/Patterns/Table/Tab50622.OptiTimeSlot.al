table 50622 "Opti Time Slot"
{
    ...
    keys
    {
        ...
        key(TimeSlotDefinition; "Start Time", "End Time", "Idle Time")
        {
            Unique = true;
        }
    }
    ...
    procedure GetOrCreateTimeSlotID(
        StartTime: Time;
        EndTime: Time;
        RestMinutes: Integer) TimeSLotID: Integer
    var
    ...
    begin
        ...
        TimeSlotId := GetTimeSlotID(StartTime, EndTime, RestMinutes, SlotHash);
    ...
    begin
        SlotHash := GenerateTimeSlotHash(
            ...
            EndTime,
            RestMinutes);
        exit(GetTimeSlotID(StartTime, EndTime, RestMinutes, SlotHash));
    end;
    ...
    begin
        ...
        if "Idle Time" >= GrossMinutes then
            Error(
                RestTooLongErr,
                "Idle Time",
                GrossMinutes);
    ...
    begin
        ...
        "Working Minutes" := GrossMinutes - "Idle Time";
