table 50624 "Opti Week Pattern Line"
{
    Caption = 'Capacity Pattern Day';
    DataClassification = CustomerContent;

    fields
    {
        field(1; "Capacity Pattern ID"; Integer)
        {
            Caption = 'Capacity Pattern ID';
            TableRelation = "Opti Week Pattern"."Week Pattern ID";
        }
        ...
        field(40; "Day Pattern Description"; Text[100])
        {
            ...
            CalcFormula =
                lookup("Opti Day Pattern".Description
                    where("Day Pattern ID" = field("Day Pattern ID")));
            Editable = false;
        }
        field(50; "Working Minutes"; Integer)
        {
            ...
            FieldClass = FlowField;
            CalcFormula =
                lookup("Opti Day Pattern"."Total Working Minutes"
                    where("Day Pattern ID" = field("Day Pattern ID")));
            Editable = false;
        }
        field(60; "Working Hours"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula =
                lookup("Opti Day Pattern"."Total Working Hours"
                    where("Day Pattern ID" = field("Day Pattern ID")));
            DecimalPlaces = 0 : 5;
            Editable = false;
        }
        field(70; "No. of Time Slots"; Integer)
        {
            ...
            FieldClass = FlowField;
            CalcFormula =
                lookup("Opti Day Pattern"."No. of Time Slots"
                    where("Day Pattern ID" = field("Day Pattern ID")));
            Editable = false;
        }
        field(80; "Day Pattern Hash"; Text[64])
        {
            ...
            FieldClass = FlowField;
            CalcFormula =
                lookup("Opti Day Pattern"."Pattern Hash"
                    where("Day Pattern ID" = field("Day Pattern ID")));
            Editable = false;
        }
    }
    ...
    keys
    {
        key(PK; "Capacity Pattern ID", "Weekday No.")
        {
            Clustered = true;
        }
    ...
    procedure SetWeekday(NewWeekdayNo: Integer)
    begin
        Validate("Weekday No.", NewWeekdayNo);
    end;
